...
# or obliga que se cumpla al menos una de las condiciones
...
# Se pueden combinar entre ellos de cualquier manera. Por ejemplo cambiamos la línea de condicionales por una
# combinación de and, or y operadores lógicos (los paréntesis). -------> #
...
# Primero ejecuta cada paréntesis y arroja un Frue o False, y luego entrará en juego el and que une ambos paréntesis.